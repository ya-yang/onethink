...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="blank"></div>
        <h3 class="noticeDetailTitle"><strong><?php echo $shop[0]['title'];?></strong></h3>
        <div class="noticeDetailInfo">发布者:<?php echo $shop[0]['nickname'];?></div>
        <div class="noticeDetailInfo">发布时间：<?php echo date('Y-m-d H:i:s',$shop[0]['create_time']); ?></div>
