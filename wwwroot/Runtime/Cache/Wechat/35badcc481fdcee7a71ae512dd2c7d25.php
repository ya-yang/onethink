...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="blank"></div>
        <h3 class="noticeDetailTitle"><strong><?php echo $sale['title'] ?></strong></h3>
        <div class="noticeDetailInfo">发布者:<?php echo $sale['name'] ?></div>
        <div class="noticeDetailInfo">发布时间：<?php echo date('Y-m-d H:i:s',$sale['create_time']) ?></div>
        <div class="noticeDetailInfo">联系电话：<?php echo $sale['tel'] ?></div>
        <h4 class="text-danger">价格:<?php echo $sale['price']; echo $sale['unit']?'万元':'元/月' ?></h4>
