...
<div class="main">
    ...
    <div class="container">
        ...
        <form class="form-signin login-form" action="<?php echo U('User/login');?>" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <img class="verifyimg reloadverify" alt="点击切换" src="/wechat.php/User/verify.html" style="cursor:pointer;">
                </div>
        ...
        <p class="text-danger text-right"><a href="<?php echo U('User/register');?>">新用户注册</a></p>
    </div>
