    ...
    <div class="container-fluid">
        <form class="login-form" action="<?php echo U('User/register');?>" method="post">
            ...
            <div class="controls" style="margin-bottom: 20px;">
                <img class="verifyimg reloadverify" alt="点击切换" onclick="this.src='/wechat.php/User/verify.html'" src="/wechat.php/User/verify.html" style="cursor:pointer;height: 40px;">
            </div>
            <p>
