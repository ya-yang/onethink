...
<div class="main">
    ...
    <div class="container-fluid" id="list">
        ...
        <div class="row noticeList">
            <a class="detail_view" data-id="<?php echo $activity['id'];?>" href="<?php echo U('Shop/detail?id='.$activity['id']);?>">
                <div class="col-xs-2">
                    <img class="noticeImg" src="<?php echo get_cover($activity['cover_id'],$field = path);?>" />
                </div>
                <div class="col-xs-10">
                    <p class="title"><?php echo $activity['title'];?></p>
                    <p class="intro"><?php echo $activity['description'];?></p>
                    <p class="info">浏览: <span class="view"><?php echo $activity['view']?></span> <span class="pull-right"><?php echo date('Y-m-d H:i:s',$activity['update_time']); ?></span> </p>
                </div>
            </a>
        </div>
        <?php endforeach;?>
