...
<body>
    ...
    <div class="main-title">
        <h2><?php echo ($info['id']?'修改':'添加'); ?>租售</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                ...
                单位：<select name="unit">
                <option value="0" <?php if($info["unit"] == 0 ): ?>selected="selected"
                <?php else: endif; ?>>元/月</option>
                <option value="1" <?php if($info["unit"] == 1 ): ?>selected="selected"
                <?php else: endif; ?>>万元/月</option>
            </select>
            </div>
        </div>
        <div class="form-item">
            ...
            <div class="controls">
               <select name="type">
                   <option value="1" <?php if($info["type"] == 1 ): ?>selected="selected"
                   <?php else: endif; ?>>出租</option>
                   <option value="2" <?php if($info["type"] == 2 ): ?>selected="selected"
                   <?php else: endif; ?>>出售</option>
               </select>
                状态：<select name="status">
                <option value="0" <?php if($info["status"] == 0 ): ?>selected="selected"
                <?php else: endif; ?>>未租/售</option>
                <option value="1" <?php if($info["status"] == 1 ): ?>selected="selected"
                <?php else: endif; ?>>已租/售</option>
            </select>
        ...
        <div class="form-item">
            <div class="controls">
                ...
                <input id="path" type="hidden" name="path" value="<?php echo ((isset($info["path"]) && ($info["path"] !== ""))?($info["path"]):''); ?>"/>
                ...
                <script type="text/javascript">
                    ...
                    $('#upload_button').uploadify({
                        ...
                        'uploader' : '<?php echo U("sale/uploadify");?>',//这个就是处理上传文件的地址
                        'width': 80,
                        'buttonText' : '上传照片',
        ...
        <div class="form-item">
           <!-- <label class="item-label">内容</label>
            <div class="controls">
                <label class="textarea input-large"><textarea name="content"><?php echo ($info["content"]); ?></textarea></label>
            </div>
        </div>-->
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <label class="textarea input-large"><textarea name="description"><?php echo ($info["description"]); ?></textarea></label>
            </div>
        </div>
        <div class="form-item">
