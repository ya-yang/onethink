...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
               <select name="type">
                   <option value="<?php echo ((isset($info["type"]) && ($info["type"] !== ""))?($info["type"]):'1'); ?>">出租</option>
                   <option value="<?php echo ((isset($info["type"]) && ($info["type"] !== ""))?($info["type"]):'2'); ?>">出售</option>
               </select>
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="datetime-local" class="text time" name="end_time" value="<?php echo ((isset($info["end_time"]) && ($info["end_time"] !== ""))?($info["end_time"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
